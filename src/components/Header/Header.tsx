...
export function Header(): ReactElement {
  ...
  function handleHideHeader() {
    if (!isHide && window.scrollY > lastScroll && window.scrollY > defaultOffset) {
      setIsHide(true);
      setIsNavHide(true);
    } else if (isHide && !isOpen && window.scrollY < lastScroll) {
      setIsHide(false);
    }
