...
export function Header(): ReactElement {
  ...
  function handleHideHeader() {
    if (window.scrollY > lastScroll && window.scrollY > defaultOffset) {
      setIsHide(true);
    } else {
      setIsHide(false);
    }
