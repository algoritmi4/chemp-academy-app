...
export function MainForm(): ReactElement {
  ...
  return (
    <form className="flex flex-col max-w-[315px] xl:max-w-[410px]">
      <p className="text-[15px] font-normal lg:text-[16px]">Свяжитесь с нами!</p>
      <div className="mt-[50px] flex flex-col">
        <input
          ...
          required
        />
        <label htmlFor="initials" className="mt-[5px] text-[13px] font-normal leading-none">Заполните ФИО, чтобы мы могли корректно к вам обратиться</label>
      </div>
      ...
      <button type="submit" className="self-start font-normal text-[17px] h-[41px] px-[15px] bg-red rounded-[20px] leading-none mt-10">Отправить</button>
    </form>
  )
}
