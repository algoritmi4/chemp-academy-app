...
export function PriceBlock({ title, text, price }: IPriceBlock): ReactElement {
  return (
    <div className="flex flex-col">
      <figure className="flex flex-col items-center mt-[50px] px-[60px]">
      ...
      <button type="button" className="self-center px-6 py-3 text-red border-solid border-red border-2 rounded-[30px] leading-none mt-10">{price}</button>
    </div>
  )
}
